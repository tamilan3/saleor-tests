...
from ..core.doc_category import DOC_CATEGORY_PRODUCTS, DOC_CATEGORY_TAG, DOC_CATEGORY_WISHLIST
...
def encode_cursor(cursor):
    return base64.b64encode(str(cursor).encode()).decode()
...
class ProductMutations(graphene.ObjectType):
    ...
    tag_create = TagCreate.Field()
    tag_delete = TagDelete.Field()
